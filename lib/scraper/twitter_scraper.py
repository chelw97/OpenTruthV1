...
- Twitter is experiencing unusual activity"""
    ...
    def scrape_tweets(
        ...
        assert self.login_bool, "Login first before scraping tweets"
        self._config_scraper(
            max_tweets,
            scrape_username,
            scrape_hashtag,
    ...
    def get_tweets(self):
        '''
        columns: Name, Handle, Timestamp, Verified, Content, Comments, Retweets, Likes, Analytics, Tags, Mentions, Emojis, Profile Image, Tweet Link, Tweet ID
        '''
        return self.data
